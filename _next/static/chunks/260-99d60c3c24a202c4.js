            ...
            ! function(e, t, n) {
                ...
                var i = ["animationData", "loop", "autoplay", "initialSegment", "onComplete", "onLoopComplete", "onEnterFrame", "onSegmentStart", "onConfigReady", "onDataReady", "onDataFailed", "onLoadedImages", "onDOMLoaded", "onDestroy", "lottieRef", "renderer", "name", "assetsPath", "rendererSettings"],
                    useLottie = function(e, t) {
                        ...
                        var A = _objectWithoutProperties(e, i),
                            L = function(e) {
                            ...
                            loadAnimation = function() {
                                ...
                                if (P.current) {
                                    ...
                                    return O.current = r.default.loadAnimation(o), w(!!O.current),
                                        function() {
                                            var e;
                                            null === (e = O.current) || void 0 === e || e.destroy(), O.current = void 0
                                        }
                                }
                            };
                        return n.useEffect(function() {
                            ...
                            if (O.current) {
                                ...
                                Array.isArray(c) && c.length && ((O.current.currentRawFrame < c[0] || O.current.currentRawFrame > c[1]) && (O.current.currentRawFrame = c[0]), O.current.setSegment(c[0], c[1]))
                            }
                            ...
                            if (e.length) {
                                var t = e.map(function(e) {
                                    var t;
                                    return null === (t = O.current) || void 0 === t || t.addEventListener(e.name, e.handler),
                                        function() {
                                            var t;
                                            null === (t = O.current) || void 0 === t || t.removeEventListener(e.name, e.handler)
                                        }
                                });
                                return function() {
                            ...
                            goToAndStop: function(e, t) {
                                var n;
                                null === (n = O.current) || void 0 === n || n.goToAndStop(e, t)
                            },
                            goToAndPlay: function(e, t) {
                                var n;
                                null === (n = O.current) || void 0 === n || n.goToAndPlay(e, t)
                            },
                            ...
                            playSegments: function(e, t) {
                                var n;
                                null === (n = O.current) || void 0 === n || n.playSegments(e, t)
                            },
                            ...
                            getDuration: function(e) {
                                var t;
                                return null === (t = O.current) || void 0 === t ? void 0 : t.getDuration(e)
                            },
                            destroy: function() {
                                var e;
                                null === (e = O.current) || void 0 === e || e.destroy(), O.current = void 0
                                            ...
                                            if (d) {
                                                if ("seek" === d.type && d.position && Array.isArray(d.position.x) && Array.isArray(d.position.y) && 2 === d.frames.length) {
                                                    var m = (n - d.position.x[0]) / (d.position.x[1] - d.position.x[0]),
                                                        y = (o - d.position.y[0]) / (d.position.y[1] - d.position.y[0]);
                ...
                Object.defineProperty(e, "LottiePlayer", {
                    ...
                    var t, r, o, i = e.style,
                        u = e.interactivity,
                        l = useLottie(_objectWithoutProperties(e, a), i),
                        s = l.View,
                        c = l.play,
                        f = l.stop,
                        d = l.pause,
                    ...
                    return n.useEffect(function() {
                        ...
                        actions: null !== (r = null == u ? void 0 : u.actions) && void 0 !== r ? r : [],
                        mode: null !== (o = null == u ? void 0 : u.mode) && void 0 !== o ? o : "scroll"
                    })
